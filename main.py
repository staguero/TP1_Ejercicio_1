...
if __name__ == "__main__":
    ...
    mapa_color=Dibujar(25,mapa_columnas,mapa_filas,columnas_estante,estantes_f,estantes_c)
    ...
    #Dibujo del mapa 
    mapa_full=Dibujar(25,mapa_columnas,mapa_filas,columnas_estante,estantes_f,estantes_c)
